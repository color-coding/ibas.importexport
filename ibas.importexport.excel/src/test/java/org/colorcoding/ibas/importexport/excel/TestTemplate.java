...
public class TestTemplate extends TestCase {
	...
	public void testRresolving() throws ResolvingException, WriteFileException, IOException {
		...
		IUserField<String> userField01 = order.getUserFields().register("U_0001", String.class);
		IUserField<BigDecimal> userField02 = order.getUserFields().register("U_0002", BigDecimal.class);
		IUserField<DateTime> userField03 = order.getUserFields().register("U_0003", DateTime.class);
