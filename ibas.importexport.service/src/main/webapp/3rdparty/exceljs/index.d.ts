...
declare namespace ExcelJS {
	...
	export interface Buffer extends ArrayBuffer { }
	...
	export interface Xlsx {
		 ...
		 * @param stream
		 */
		read(stream: any, options?: Partial<XlsxReadOptions>): Promise<Workbook>;
		 ...
		 * write to a stream
		 */
		write(stream: any, options?: Partial<XlsxWriteOptions>): Promise<void>;
	}
	...
	export interface Csv {
		 ...
		 * read from a stream
		 */
		read(stream: any, options?: Partial<CsvReadOptions>): Promise<Worksheet>;

		/**
		 * Create input stream for reading
		 */
		createInputStream(options?: Partial<CsvReadOptions>): any;
		 ...
		 * write to a stream
		 */
		write(stream: any, options?: Partial<CsvWriteOptions>): Promise<void>;
	}
	...
	export namespace stream {
		namespace xlsx {
			...
			class WorkbookReader extends Workbook {
				constructor(input: string | any, options: Partial<WorkbookStreamReaderOptions>);
				read(): Promise<void>;
