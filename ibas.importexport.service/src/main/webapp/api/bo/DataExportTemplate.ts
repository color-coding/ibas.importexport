...
namespace importexport {
    export namespace bo {
        ...
        /** 数据导出模板 */
        export interface IDataExportTemplate extends ibas.IBOSimple {
        ...
        /** 数据导出模板-项 */
        export interface IDataExportTemplateItem extends ibas.IBOSimpleLine {
        ...
        /** 数据导出模板-项 集合 */
        export interface IDataExportTemplateItems extends ibas.IBusinessObjects<IDataExportTemplateItem> {
