...
namespace importexport {
    export namespace bo {
        ...
        /** 数据导出模板 */
        export class DataExportTemplate extends ibas.BOSimple<DataExportTemplate> implements IDataExportTemplate {
            ...
            get approvalStatus(): ibas.emApprovalStatus {
                return this.getProperty<ibas.emApprovalStatus>(DataExportTemplate.PROPERTY_APPROVALSTATUS_NAME);
            }
            /** 设置-审批状态 */
            ...
            /** 获取-是否可以修改 */
            get canChange(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(DataExportTemplate.PROPERTY_CANCHANGE_NAME);
            }
            /** 设置-是否可以修改 */
            set canChange(value: ibas.emYesNo) {
            ...
            protected init(): void {
                ...
                this.objectCode = ibas.config.applyVariables(DataExportTemplate.BUSINESS_OBJECT_CODE);
            }
        }

        /** 数据导出模板-项 */
        export class DataExportTemplateItem extends ibas.BOSimpleLine<DataExportTemplateItem> implements IDataExportTemplateItem {
            ...
            get itemVisible(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(DataExportTemplateItem.PROPERTY_ITEMVISIBLE_NAME);
            }
            /** 设置-项是否可见 */
        ...
        /** 数据导出模板-项 集合 */
        export class DataExportTemplateItems extends ibas.BusinessObjects<DataExportTemplateItem, DataExportTemplate> implements IDataExportTemplateItems {
