...
import { IDataExportTemplateViewView } from "../../../bsapp/DataExportTemplate/index";

/**
 * 视图-DataExportTemplate
 */
export class DataExportTemplateViewView extends ibas.BOViewView implements IDataExportTemplateViewView {
