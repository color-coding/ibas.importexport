...
namespace importexport {
    export namespace ui {
        export namespace c {
            /** 列表视图-导出模板 */
            export class ExportTemplateListView extends ibas.BOListView implements app.IExportTemplateListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        that.fireViewEvents(that.viewDataEvent,
                                            // 获取表格选中的对象
                                            openui5.utils.getSelecteds<bo.ExportTemplate>(that.table).firstOrDefault()
                                        );
                                    }
                                }),
                                new sap.m.Button("", {
